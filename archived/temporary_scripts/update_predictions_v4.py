#!/usr/bin/env python3
"""
Update Predictions v4 - Fast submission generator
==================================================
Reuses Task B from existing submission
Updates Task A predictions using checkpoints_v4 models
"""
...
def main():
    ...
    for ds in task_a_df['dataset'].unique():
