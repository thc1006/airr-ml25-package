...
===============================================
Memory-efficient GPU XGBoost with k=4 k-mers only.
...
# =============================================================================
# Feature Extraction - k=4 only for memory efficiency
# =============================================================================
...
def main():
    ...
    for train_dir in train_datasets:
        ...
        predictor = GPUOptimizedPredictor(k=4, n_jobs=8)
