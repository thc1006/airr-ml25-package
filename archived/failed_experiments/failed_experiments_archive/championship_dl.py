    ...
    def extract_embeddings(self, sequences: List[str], batch_size: int = 16, max_seqs: int = 1000) -> np.ndarray:
        ...
        with torch.no_grad():
            for i in range(0, len(sequences), batch_size):
                ...
                # Extract representations from Layer 6 (research shows L6 > L33 for TCR CDR3)
                # See: https://academic.oup.com/intimm/advance-article/doi/10.1093/intimm/dxaf048/8241037
...
def main():
    ...
    # Paths (corrected for actual data structure)
