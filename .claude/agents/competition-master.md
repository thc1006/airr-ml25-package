...
description: Strategic orchestrator for competition management. Coordinates specialized agents, manages submission strategy, risk assessment, and daily progress reviews to maximize winning probability.
model: sonnet
---
