---
name: parallel-trainer
description: GPU-optimized parallel training orchestrator. Manages multi-GPU and multi-container training, resource allocation, failure recovery, and batch job scheduling for mass model training.
model: sonnet
---
