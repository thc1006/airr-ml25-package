...
description: Competition ensemble optimization specialist. Focuses on Weighted Box Fusion (WBF) parameter tuning, file size optimization, and model diversity analysis for maximizing competition scores.
model: sonnet
---
