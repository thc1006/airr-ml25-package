# AIRR-ML-25: Adaptive Immune Profiling Challenge - Rules
...
### 5. TOTAL PRIZES AVAILABLE: $10,000
...
- The Competition Data is also subject to the following terms and conditions: https://creativecommons.org/licenses/by/4.0/.
...
- **Open Source**: You hereby license and will license your winning Submission and the source code used to generate the Submission under an **MIT Open Source license** that in no event limits commercial use of such code or model containing or depending on such code.
...
> **Warning**: Competition participants must also agree to Kaggle's Foundational Competition Rules. These rules will supersede the competition-specific rules in the event of any conflict.
...
| Daily Submission Limit | 5 submissions |
| Final Submissions | 2 selections |
| Winner License | MIT Open Source |
| Data License | CC-BY 4.0 |
| Prize Pool | $10,000 |
| 1st Prize | $5,000 |
| 2nd Prize | $3,000 |
| 3rd Prize | $2,000 |
| Code Requirement | Must be open-source to win prize |
| Top 10 Bonus | Co-authorship on Nature Methods paper |
